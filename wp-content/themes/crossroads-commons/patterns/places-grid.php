...
/**
 * Title: Places Grid
 * Slug: crossroads-commons/places-grid
...
<h2 class="wp-block-heading section-title">Spaces to Flourish</h2>
<!-- /wp:heading -->
...
<div class="places-grid">
  ...
  <div class="place-tile">
    ...
    <h3>Healthcare</h3>
    <p>Accessible health services and wellness programs for individuals and families.</p>
  </div>
  <div class="place-tile">
  ...
  <div class="place-tile">
    ...
    <h3>Event Center</h3>
    <p>A gathering place for concerts, community events, and celebrations that bring people together.</p>
  </div>
  <div class="place-tile">
    <span class="material-symbols-outlined">palette</span>
    <h3>The Arts</h3>
    <p>Creative spaces for visual arts, performance, and cultural expression for all ages.</p>
  </div>
</div>
<!-- /wp:html --></section>
<!-- /wp:group -->
